...
import mmp.im.common.server.tcp.channel.handler.ConnectorIdleStateTrigger;
import mmp.im.common.server.tcp.channel.handler.IChannelHandlerHolder;
import mmp.im.common.server.tcp.channel.handler.ReconnectHandler;
import mmp.im.common.server.tcp.channel.listener.ConnectionListener;
...
import mmp.im.gate.channel.handler.GateToAuthConnectorHandler;
...
public class GateToAuthConnector extends AbstractTCPConnector {
    ...
    public GateToAuthConnector(String host, int port) {
        this.host = host;
        this.port = port;
    }
    ...
    public void connect() {
        ...
        IChannelHandlerHolder handlerHolder = () -> {
            ...
            return new ChannelHandler[]{
                    ...
                    new GateToAuthConnectorHandler(),

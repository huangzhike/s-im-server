...
public class ClientToGateConnector extends AbstractTCPConnector {


    @Autowired
    private ClientToGateConnectorHandler clientToGateConnectorHandler;

    public ClientToGateConnector(String host, int port) {
        this.host = host;
        this.port = port;
    }

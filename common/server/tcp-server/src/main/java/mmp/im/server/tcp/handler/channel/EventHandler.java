package mmp.im.server.tcp.handler.channel;

import io.netty.channel.ChannelDuplexHandler;
import io.netty.channel.ChannelHandlerContext;
import io.netty.channel.ChannelPromise;
import mmp.im.server.tcp.event.Event;
import mmp.im.server.tcp.event.EventExecutor;
import mmp.im.server.tcp.event.EventType;
import mmp.im.server.tcp.event.IEventListener;
